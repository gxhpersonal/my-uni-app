  ...
  return {
    ...
    e: common_vendor.f($data.tableData, (item, index, i0) => {
      return {
        ...
        b: "60afd65a-7-" + i0 + "," + ("60afd65a-6-" + i0),
        c: common_vendor.t(item.name),
        d: "60afd65a-8-" + i0 + "," + ("60afd65a-6-" + i0),
        e: common_vendor.t(item.address),
        f: "60afd65a-9-" + i0 + "," + ("60afd65a-6-" + i0),
        g: "60afd65a-10-" + i0 + "," + ("60afd65a-6-" + i0),
        h: index,
        i: "60afd65a-6-" + i0 + ",60afd65a-0"
      };
    }),
    f: common_vendor.p({
      align: "center"
    }),
    g: common_vendor.sr("table", "60afd65a-0"),
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "D:/gxhfile/my-uni-app/pages/extUI/table/table.vue"]]);
